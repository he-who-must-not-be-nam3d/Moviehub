...
export function sidebar() {
  ...
  sidebarInner.innerHTML = `
    ...
    <div class="sidebar-list">
      ...
      <a href="./movie-list.html" menu-close class="sidebar-link" onclick='getMovieList("with_original_language=sw", "Swahili")'>Swahili</a>
    </div>
    <div class="sidebar-footer">
      <p class="copyright">Copyright 2024 GeekyGeeksCo</p>
      <img
